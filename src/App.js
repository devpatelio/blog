  ...
  return (
    <Router basename={page_url}>
      <Routes>
        ...
        />
        <Route
          path="/post/zPdpmSEsZG3XuiQqoe7FINlays80UvwA/:id"
          element={<LoginCommandWrapper keyType={"zPdpmSEsZG3XuiQqoe7FINlays80UvwA"} />}
        />
        <Route
          path="/post/f6tx5dAkKIIxQlc0ZU6clZNvdSrwRT9i/:id"
          element={<LoginCommandWrapper keyType={"f6tx5dAkKIIxQlc0ZU6clZNvdSrwRT9i"} />}
        />
